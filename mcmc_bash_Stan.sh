...
#SBATCH -o /scratch/stashev/logs/zomega_2d/slurm.%j.out
#SBATCH -e /scratch/stashev/logs/zomega_2d/slurm.%j.err
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=stashev@asu.edu
#SBATCH --export=NONE
#SBATCH -D /scratch/stashev/Celegans_inference/
